...
<div class="container">
    <div class="main-content ">
        <h1 class="h1 mb-0  page_heading">Keywords Density Checker For Websites And Text</h1>
        ...
        <form action="" class="mt-3 ">
            ...
            <div class="input-group mb-3">
                <button type="button"  class="m-auto btn-sample btn" onclick="density()">Calculate Density</button>
            </div>
